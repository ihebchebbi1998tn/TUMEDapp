...
public class frame_1_activity extends Activity {
    ...
    private EditText Phone; // Change to EditText
    private View rectangle_6;
    private View rectangle_2;
    private Spinner zoneSpinner;
    String zone ;
    private EditText Name; // Change to EditText
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Phone = findViewById(R.id.TelAgent); // Change to EditText

        Name = findViewById(R.id.NomPrenom); // Change to EditText
    ...
    public void onclickOk(View ClickOK) {
        ...
        String password = Motdepassagent.getText().toString().trim();
